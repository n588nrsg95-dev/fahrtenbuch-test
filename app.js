...
function load(){try{const raw=localStorage.getItem(KEY)||localStorage.getItem('fahrtenbuch_v5_17')||localStorage.getItem('fahrtenbuch_v5_12')||localStorage.getItem('fahrtenbuch_v5_10')||localStorage.getItem('fahrtenbuch.v5')||localStorage.getItem('fahrtenbuch.v4');return norm(raw?JSON.parse(raw):{})}catch{return norm({})}}
function norm(d){
